...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") 
    {
      ...
      else 
      {
        ...
        {
          $nameErr = "Must contain alpha numeric characters, period, dash or underscore only";
        }
        else if (strlen($name)<2) 
        {
          $nameErr = "Username must contain at least two characters";
        }
 ...
 <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
    <fieldset >
      ...
      <a href="Change Password.php"><span class="blue">Forget Password?</span></a>
     </fieldset>
 </form>
</body>
</html>